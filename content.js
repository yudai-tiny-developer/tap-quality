...
function main(common) {
    ...
    function update_button(button, label, value, default_value, enabled, default_enabled) {
        ...
        button.innerHTML = `<span class="ytp-live" translate="no">${label}</span>`;
    ...
    button_container.classList.add('_tap_quality_button_container');
    ...
    button_container.appendChild(button_v9);
